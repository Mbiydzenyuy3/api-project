...
fetch(`https://www.swapi.tech/api/films`)
  ...
  .then((data) => {
    console.log(data);
    let charNameOne = document.getElementById('para-one');
    let charNameTwo = document.getElementById("para-two");
    let charNameThree = document.getElementById("para-three");
    let charNameFour = document.getElementById("para-four");
    let charNameFive = document.getElementById("para-five");
    let charNameSix = document.getElementById("para-six");
